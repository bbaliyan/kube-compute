...
| `modules/aws-node-pool`     | AWS worker group: an Auto Scaling group cluster-autoscaler scales from zero, joining an existing aws-control-plane cluster (AlmaLinux 10). |
