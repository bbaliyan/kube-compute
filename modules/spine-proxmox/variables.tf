...
variable "extra_tags" {
  description = "Additional Proxmox VM tags applied to every control-plane VM, and forwarded to node-bootstrap's platform Application (helm.valuesObject.extraTags)."
  type        = map(string)
  default     = {}
}
