...
output "cluster_ipset_name" {
  description = "Name of the cluster-wide firewall ipset (see module README for its subnet-CIDR scoping rationale). Worker pools reference this by name ('+<name>') in their own per-VM firewall rules — they never create or own this ipset."
