...
# ---- Node-scoped NSG — the pool owns only this; the control plane's cluster ASG membership
...
# ---- Fixed node pool: VM Scale Set, one zone, system-assigned managed identity ----
